...
public class ResizingHashMapPublicTest {
    ...
    public void mainTestInsertEntry() throws Exception {
        ...
        assertEquals("Size wrong ", hashMap.size(), 1);
        assertEquals("Pair not found in expected bucket with index 1", hashMap.buckets[1], e1);
    }
    ...
    public void mainTestGetEntry() throws Exception {
        ...
        // Get Pair Object
        Pair<Integer, String> q = hashMap.getEntry(1);
